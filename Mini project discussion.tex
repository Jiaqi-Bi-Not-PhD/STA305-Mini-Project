...
Our topic will be ``If you shave hair, it comes back thicker." An experiment needs to be carried out with realistic situation and plan. The \underline{target population} for our experiment design will be the whole population in the world, the sample can be 50-80 people with different age groups (\underline{sample size}). The \underline{experimental unit} will be the person selected for sample purposes of our experiment. Different treatment for two groups (\underline{2 groups}): 
\begin{itemize}
\item Treatment Group: Shave the hair;
\item Control Group: Does not shave the hair.
\end{itemize}
